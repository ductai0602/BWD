...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const descire = ["Trường Đại học Công nghệ Thông tin và Truyền thông Việt – Hàn (VKU), ĐHĐN đã tổ chức và đón gần 2.000 học sinh các trường Trung học phổ thông (THPT) trên địa bàn thành phố Đà Nẵng và các tỉnh Quảng Nam, Quảng Ngãi, Thừa Thiên Huế về tham gia Trải nghiệm VKU Campus tour 2024.",
    ...
    function redirectToLink(index) {
        window.open(link[current2]) ; 
    }

    detail.addEventListener('click', () => {
        redirectToLink(current2) ; 
    })

    function updateText() {
        paragraph.textContent = title[current2];
        dcb.textContent = descire[current2];
    }
